...
import com.studio.yami.moviecataloguefinal.databinding.FragmentMovieBinding;
...
public class MovieFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        rvMain = binding.rvMovie;
        load = binding.loadMovie;
    ...
    private void getViewModel(){
        ...
        viewModel.getMovieList().observe(this, new Observer<List<FilmList>>() {
            @Override
